    ...
    public class ObservationCode
    {
        ...
        public List<ObservationCode> observationCode()
        {
            var obser_code_lists = new List<ObservationCode>
            {
                ...
                new ObservationCode {code = "83174-3", display = "Grip strength Hand - right Dynamometer", chinese = "握力_右手測力計"},
                new ObservationCode {code = "59408-5", display = "Oxygen saturation in Arterial blood by Pulse oximetry", chinese = "動脈血氧飽和度"},
